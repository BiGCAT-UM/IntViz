...
/**
 * Visualization method for coloring by data: can color a line by a value
 * 
 * @author anwesha
 */
public class ThicknessByLine extends AbstractVisualizationMethod {
	...
	public ThicknessByLine(GexManager gexManager, ColorSetManager csm) {
	...
	public String getDescription() {
		return "Change thickness of line according to data";
	}

	@Override
	public String getName() {
		return "Data as linethickness";
	}

	@Override
	public JPanel getConfigurationPanel() {
		return new ThicknessByLinePanel(this, csm);
	}
	...
	private void drawSample(ConfiguredSample s, List<? extends IRow> data,
		...
		changeLineThickness(gp, g2d, dataval, sample);
	}
	...
	private void changeLineThickness(Line gp, Graphics2D g2d, IRow dataval, ISample sample){
...
//		drawHead(g2d, hs, lt, c);
	...
	public class ConfiguredSample {
		...
		protected ThicknessByLine getMethod() {
			return ThicknessByLine.this;
		}
