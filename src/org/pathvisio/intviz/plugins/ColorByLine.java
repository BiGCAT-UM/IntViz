...
public class ColorByLine extends AbstractVisualizationMethod {
	...
	/**
	 * Set color to visualize positive and negative values of data on lines Set
	 * choose a minimum and maximum linethickness to create a gradient of
	 * linethicknesses to visualize on lines
	 */
